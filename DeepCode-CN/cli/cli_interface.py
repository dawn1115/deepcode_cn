...
║                             欢迎使用 DEEPCODE CLI                           ║
╠═══════════════════════════════════════════════════════════════════════════════╣
║  {Colors.YELLOW}开源代码智能体 | 香港大学数据智能实验室 | MIT 许可证                 {Colors.CYAN}║
║  {Colors.GREEN}状态: 就绪 | 引擎: 多智能体架构已初始化                                    {Colors.CYAN}║
║  {Colors.PURPLE}使命: 革新研究可复现性                                                   {Colors.CYAN}║
║                                                                               ║
║  {Colors.BOLD}{Colors.OKCYAN}💎 核心能力:{Colors.ENDC}                                                              {Colors.CYAN}║
║    {Colors.BOLD}{Colors.OKCYAN}▶ 自动化论文到代码复现                                              {Colors.CYAN}║
║    {Colors.BOLD}{Colors.OKCYAN}▶ 协作式多智能体架构                                                {Colors.CYAN}║
║    {Colors.BOLD}{Colors.OKCYAN}▶ 智能代码实现与验证                                                {Colors.CYAN}║
║    {Colors.BOLD}{Colors.OKCYAN}▶ 未来愿景: 一句话 → 完整代码库                                     {Colors.CYAN}║
╚═══════════════════════════════════════════════════════════════════════════════╝{Colors.ENDC}
"""
        print(banner)
...
║                                主菜单                                          ║
╠═══════════════════════════════════════════════════════════════════════════════╣
║  {Colors.OKGREEN}🌐 [U] 处理URL         {Colors.CYAN}│  {Colors.PURPLE}📁 [F] 上传文件      {Colors.CYAN}│  {Colors.MAGENTA}💬 [T] 聊天输入{Colors.CYAN}      ║
║  {Colors.OKCYAN}⚙️  [C] 配置            {Colors.CYAN}│  {Colors.YELLOW}📊 [H] 历史记录      {Colors.CYAN}│  {Colors.FAIL}❌ [Q] 退出{Colors.CYAN}           ║
║                                                                               ║
║  {Colors.BOLD}🤖 当前流水线模式: {pipeline_mode}{Colors.CYAN}                                ║
║  {Colors.BOLD}🗂️  代码库索引: {index_status}{Colors.CYAN}                                            ║
║  {Colors.BOLD}📄 文档处理: {segmentation_mode}{Colors.CYAN}                                           ║
║                                                                               ║
║  {Colors.YELLOW}📝 URL处理:{Colors.CYAN}                                                                 ║
║  {Colors.YELLOW}   ▶ 输入研究论文URL (arXiv, IEEE, ACM等)                                {Colors.CYAN}║
║  {Colors.YELLOW}   ▶ 支持直接PDF链接和学术论文页面                                       {Colors.CYAN}║
║                                                                               ║
║  {Colors.PURPLE}📁 文件处理:{Colors.CYAN}                                                                ║
║  {Colors.PURPLE}   ▶ 上传PDF、DOCX、PPTX、HTML或TXT文件                                  {Colors.CYAN}║
║  {Colors.PURPLE}   ▶ 智能文件格式检测和处理                                             {Colors.CYAN}║
║                                                                               ║
║  {Colors.MAGENTA}💬 聊天输入:{Colors.CYAN}                                                               ║
║  {Colors.MAGENTA}   ▶ 用自然语言描述您的编码需求                                          {Colors.CYAN}║
║  {Colors.MAGENTA}   ▶ AI自动生成实现计划和代码                                            {Colors.CYAN}║
║                                                                               ║
║  {Colors.OKCYAN}🔄 处理流水线:{Colors.CYAN}                                                                ║
║  {Colors.OKCYAN}   ▶ 智能体编排 → 代码合成                                             {Colors.CYAN}║
║  {Colors.OKCYAN}   ▶ 多智能体协调与进度跟踪                                             {Colors.CYAN}║
╚═══════════════════════════════════════════════════════════════════════════════╝{Colors.ENDC}
"""
        print(menu)
